...
export default class Groups extends React.Component{
    ...
    deleteRecord(record, e) {
        ...
        confirm({
            ...
            title: <div className='_confirm-dialog-title'><IconSvg name="icon-warning" /><span>确定要删除组 <b>{name || id || ''}</b> 吗？</span></div>,
            icon: null,
            content: <p className='_confirm-dialog-content confirm-warn-msg'>如果不确定是否要从系统中删除该组，建议先冻结该组</p>,
            onOk() {
        ...
        return (
            <div className={styles['container']}>
                ...
                <div className={styles['header']}>
                    <Button type="primary" onClick={this.createRecord.bind(this)}>新建组</Button>
                </div>
